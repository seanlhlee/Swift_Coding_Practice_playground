...
struct SomeStructure: FirstProtocol_, AnotherProtocol_ {
...
class SomeClass: SomeSuperclass, FirstProtocol_, AnotherProtocol_ {
	// class definition goes here
}
/*:
...
extension Int: SomeProtocol {
	...
	//雖然protocol中的doesNotNeedToBeSettable只定義getter還是可以實作setter, 並不影響protocol conforming
...
var a = 1234
a.doesNotNeedToBeSettable
a.doesNotNeedToBeSettable = 5
a
/*:
...
//因為在class中若type property必須讓subclass override應該在原class使用class var這樣的語法, 試試看
/*:
...
/*:
[Modifying Value Types from Within Instance Methods]:https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Methods.html#//apple_ref/doc/uid/TP40014097-CH15-ID239 ""
...
*/
class SomeClass_: SomeProtocol___ {
...
[Preventing Overrides]:https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Inheritance.html#//apple_ref/doc/uid/TP40014097-CH17-ID202 ""
...
*/
protocol SomeProtocol____ {
	init()
}

class SomeSuperClass____ {
	init() {
		// initializer implementation goes here
	}
}

class SomeSubClass____: SomeSuperClass____, SomeProtocol____ {
...
/*:
[Break]:https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/ControlFlow.html#//apple_ref/doc/uid/TP40014097-CH9-ID137 ""
[Control Flow]:https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/ControlFlow.html#//apple_ref/doc/uid/TP40014097-CH9-ID120 ""
...
/*:
[Protocols as Types]:https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Protocols.html#//apple_ref/doc/uid/TP40014097-CH25-ID275 ""
...
[Classes Are Reference Types]:https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/ClassesAndStructures.html#//apple_ref/doc/uid/TP40014097-CH13-ID89 ""
...
/*:
[Linking Multiple Levels of Chaining]:https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/OptionalChaining.html#//apple_ref/doc/uid/TP40014097-CH21-ID252 ""
...
Because the call to incrementForCount(_:) can fail for either of these two reasons, the call returns an optional Int value. This is true even though incrementForCount(_:) is defined as returning a nonoptional Int value in the definition of CounterDataSource. Even though there are two optional chaining operations, one after another, the result is still wrapped in a single optional. For more information about using multiple optional chaining operations, see [Linking Multiple Levels of Chaining].
...
*/
let generator_ = LinearCongruentialGenerator()
print("Here's a random number: \(generator_.random())")
// prints "Here's a random number: 0.37464991998171"
print("And here's a random Boolean: \(generator_.randomBool())")
...
/*:
[Where Clauses]:https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Generics.html#//apple_ref/doc/uid/TP40014097-CH26-ID192 ""
