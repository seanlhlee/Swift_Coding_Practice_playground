...
// cats have 4 legs
// spiders have 8 legs
for key in numberOfLegs.keys.sort() {
	print(key)
}
/*:
...
![](https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Art/snakesAndLadders_2x.png "")
...
*/
let finalSquare_x = 25
var board_x = [Int](count: finalSquare_x + 1, repeatedValue: 0)
/*:
...
*/
board_x[03] = +08; board_x[06] = +11; board_x[09] = +09; board_x[10] = +02
board_x[14] = -10; board_x[19] = -11; board_x[22] = -02; board_x[24] = -08
board_x
/*:
...
var square_x = 0
var diceRoll_x = 0
while square_x < finalSquare_x {
	// roll the dice
	if ++diceRoll_x == 7 { diceRoll_x = 1 }
	// move by the rolled amount
	square_x += diceRoll_x
	if square_x < board_x.count {
		// if we're still on the board, move up or down for a snake or a ladder
		square_x += board_x[square_x]
	}
}
print("Game over!")
/*:
...
[Break in a Switch Statement]:https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/ControlFlow.html#//apple_ref/doc/uid/TP40014097-CH9-ID139 ""

> Although break is not required in Swift, you can still use a break statement to match and ignore a particular case, or to break out of a matched case before that case has completed its execution. See for [Break in a Switch Statement] details.
...
[Fallthrough]:https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/ControlFlow.html#//apple_ref/doc/uid/TP40014097-CH9-ID140 ""
...
![](https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Art/coordinateGraphSimple_2x.png "")
...
![](https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Art/coordinateGraphMedium_2x.png "")
...
Once the temporary constants are declared, they can be used within the case’s code block. Here, they are used as shorthand for printing the values with the print(_:separator:terminator:) function.
...
![](https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Art/coordinateGraphComplex_2x.png "")
...
[Propagating Errors Using Throwing Functions]:https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/ErrorHandling.html#//apple_ref/doc/uid/TP40014097-CH42-ID510 ""
...
*/
let finalSquare_ = 25
var board_ = [Int](count: finalSquare_ + 1, repeatedValue: 0)
board[03] = +08; board[06] = +11; board[09] = +09; board[10] = +02
board[14] = -10; board[19] = -11; board[22] = -02; board[24] = -08
var square_ = 0
var diceRoll_ = 0
...
*/
gameLoop: while square != finalSquare_ {
	if ++diceRoll_ == 7 { diceRoll_ = 1 }
	switch square_ + diceRoll_ {
	case finalSquare_:
		// diceRoll will move us to the final square, so the game is over
		break gameLoop
	case let newSquare where newSquare > finalSquare_:
		// diceRoll will move us beyond the final square, so roll again
		continue gameLoop
	default:
		// this is a valid move, so find out its effect
		square_ += diceRoll_
		square_ += board[square_]
	}
}
print("Game over!")
/*:
