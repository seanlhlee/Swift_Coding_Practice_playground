...
[Deinitialization]:https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Deinitialization.html#//apple_ref/doc/uid/TP40014097-CH19-ID142 ""
...
let beetsQuestion = SurveyQuestion_(text: "How about beets?")
beetsQuestion.ask()
...
[Class Inheritance and Initialization]:https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Initialization.html#//apple_ref/doc/uid/TP40014097-CH18-ID216 ""
...
extension Rect1 {
	//新增一個center的computed property 
	//在extension中實作以center為主的initializer
	var center: Point {
		get {
	...
	init(center: Point, size: Size) {
		self.size = size    // center的setter會根據size的值設定origin, 因此size要優先被設定
		self.center = center
	}
}
/*:
...
let originRect1 = Rect1(origin: Point(x: 2.0, y: 2.0), size: Size(width: 5.0, height: 5.0))
/*:
...
let centerRect1 = Rect1(center: Point(x: 4.0, y: 4.0), size: Size(width: 3.0, height: 3.0))
centerRect1.origin.x
centerRect1.origin.y
/*:
...
[Automatic Initializer Inheritance]:https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Initialization.html#//apple_ref/doc/uid/TP40014097-CH18-ID222 ""
...
![](https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Art/twoPhaseInitialization01_2x.png "")
...
![](https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Art/twoPhaseInitialization02_2x.png "")
...
[Initializer Delegation for Class Types]:https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Initialization.html#//apple_ref/doc/uid/TP40014097-CH18-ID219 ""
...
/*:
The Vehicle class provides a default value for its only stored property, and does not provide any custom initializers itself. As a result, it automatically receives a default initializer, as described in . The default initializer (when available) is always a designated initializer for a class, and can be used to create a new Vehicle instance with a numberOfWheels of 0:
*/
let vehicle = Vehicle()
...
![](https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Art/initializersExample01_2x.png "")
...
![](https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Art/initializersExample02_2x.png "")

[Two-Phase Initialization]:https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Initialization.html#//apple_ref/doc/uid/TP40014097-CH18-ID220 ""
[Initializer Inheritance and Overriding]:https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Initialization.html#//apple_ref/doc/uid/TP40014097-CH18-ID221 ""
...
// RecipeIngredient() 繼承自Food的init(), 因此會執行self.init(name: "[Unnamed]")
// 此時self.init(name:)為oneMysteryItem的self.init(name:)因此會執行self.init(name: name, quantity: 1)
...
*/
class ShoppingListItem_: RecipeIngredient {
	var purchased = false
	var description: String {
...
![](https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Art/initializersExample03_2x.png "")

You can use all three of the inherited initializers to create a new ShoppingListItem instance:
*/
var breakfastList = [
	ShoppingListItem_(),
	ShoppingListItem_(name: "Bacon"),
	ShoppingListItem_(name: "Eggs", quantity: 6),
]
...
![](https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Art/checkersBoard_2x.png "")
