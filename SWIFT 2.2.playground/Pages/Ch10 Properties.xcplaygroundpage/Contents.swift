...
[Default Property Values]:https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Initialization.html#//apple_ref/doc/uid/TP40014097-CH18-ID206 ""
[Assigning Constant Properties During Initialization]:https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Initialization.html#//apple_ref/doc/uid/TP40014097-CH18-ID212 ""
...
///利用以下狀況可以更瞭解class與structure instance的差異
///以上的相同狀況套用在class上是可以的, 因為class為reference type, instance的屬性是參考到另一instance
///而structure為value type, instance是拷貝一份值, 而值本身被定義為常數, 之後不可修改instance之屬性
///亦即定義一class物件為常數是指定義該物件參考的值不可變, 而參考本身的屬性仍可變動；反之，structure物件為常數是指該物件的所有屬性均已設置完成而不可變動
...
var rangeOfThreeItemsClaass = FixedLengthRangeClass(firstValue: 0, length: 3)
rangeOfThreeItemsClaass.firstValue = 6
let rangeOfFourItemsClass = FixedLengthRangeClass(firstValue: 0, length: 4)
rangeOfFourItemsClass.firstValue = 6  //這裡並沒有報錯
//rangeOfFourItemsClass = FixedLengthRangeClass(firstValue: 6, length: 4)  //這裡會報錯, 因為參考的目標改變了
/*:
...
![](https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Art/computedProperties_2x.png "")
...
/*:
[Overriding]:https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Inheritance.html#//apple_ref/doc/uid/TP40014097-CH17-ID196 ""
...
[Initializer Delegation for Value Types]:https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Initialization.html#//apple_ref/doc/uid/TP40014097-CH18-ID215 ""
...
> Global constants and variables are always computed lazily, in a similar manner to . Unlike lazy stored properties, global constants and variables do not need to be marked with the lazy modifier.
...
![](https://developer.apple.com/library/ios/documentation/Swift/Conceptual/Swift_Programming_Language/Art/staticPropertiesVUMeter_2x.png "")
